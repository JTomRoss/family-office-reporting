...
_BICE_BANK_DISPLAY = {"bice": "BICE", "bice_inversiones": "Bice Inversiones", "bice_asesorias": "Bice Asesorias", "banchile": "Banchile"}
...
def get_bice(
    ...
    all_accounts_q = (
        db.query(Account)
        .filter(Account.bank_code.in_(["bice_inversiones", "bice", "bice_asesorias", "banchile"]))
        .all()
    )
    all_snaps_q = (
